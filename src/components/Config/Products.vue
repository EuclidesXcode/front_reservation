  ...
  <v-card >
    <v-card-title>
      ...
      <v-text-field
        ...
        label="Consulte produtos por Nome..."
      ></v-text-field>
    </v-card-title>
...
import { mdiTagMultiple, mdiTagPlus } from "@mdi/js";
...
export default {
  ...
  methods: {
    ...
    async initialize() {
      ...
      this.products = this.dataTable;
      console.log("products: ", this.dataTable);
    },

    async hendleSubmit() {
      await this.createProduct(this.newProduct);
      console.log("estou enviando: ", this.newProduct);
      if (!this.error) {
        await this.initialize();
        this.dialog = false;
        ...
        await this.initialize();
        this.dialog = false;
        this.msg = "Produto já cadastrado!";
        this.snackbar = true;
      }
    },

    async deleteItem(item) {
      await this.deleteProduct(item._id);
      if (!this.error) await this.initialize();
      this.msg = "Produto detelado!";
      this.snackbar = true;
    },
